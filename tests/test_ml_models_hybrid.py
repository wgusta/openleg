...
def test_archetype_profiles_not_identical():
    office = ml_models.generate_mock_profiles(
        annual_consumption_kwh=12000, potential_pv_kwp=5, num_intervals=96, archetype='office'
    )
    efh = ml_models.generate_mock_profiles(
        annual_consumption_kwh=12000, potential_pv_kwp=5, num_intervals=96, archetype='EFH'
    )
